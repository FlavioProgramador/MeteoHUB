...
export function AirQualityCard({ data }: AirQualityCardProps) {
  ...
  const aqiInfo = AQI_DICT[current.main.aqi] || {
    label: "Desconhecida",
    color: "#9E9E9E",
    textColor: "#fff",
  };
  ...
  return (
    <div className={`${styles.airQualityCard} glass-panel`}>
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <InfoTooltip
          content={
            <>
              <strong>AQI:</strong> Índice de Qualidade do Ar
              <br />
              <strong>PM2.5:</strong> Partículas finas
              <br />
              <strong>PM10:</strong> Partículas inaláveis
              <br />
              <strong>O³:</strong> Ozônio
              <br />
      ...
      <div className={styles.content}>
        <div
          ...
          style={{ backgroundColor: aqiInfo.color, color: aqiInfo.textColor }}
        >
        ...
        <div className={styles.componentsGrid}>
          <div className={styles.componentItem}>
            <span>PM2.5</span>
            <strong>
              {current.components.pm2_5} <small>µg/m³</small>
            </strong>
          </div>
          <div className={styles.componentItem}>
            <span>PM10</span>
            <strong>
              {current.components.pm10} <small>µg/m³</small>
            </strong>
          </div>
          <div className={styles.componentItem}>
            <span>O³</span>
            <strong>
              {current.components.o3} <small>µg/m³</small>
            </strong>
          </div>
          <div className={styles.componentItem}>
            <span>NO²</span>
            <strong>
              {current.components.no2} <small>µg/m³</small>
            </strong>
          </div>
        </div>
      </div>
